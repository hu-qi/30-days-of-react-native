...
const test_opts = {
  ...
  PATH:
    argv.path || './ReactAndroid/src/androidTest/java/com/facebook/react/tests',
...
let testClasses = fs
  .readdirSync(path.resolve(process.cwd(), test_opts.PATH))
  .filter((file) => {
